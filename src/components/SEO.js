  ...
  const { site, siteLogo, defaultFb } = useStaticQuery(
    graphql`
      query {
        ...
        siteLogo: file(
          relativePath: { eq: "freinds-of-stars-experience-alberta.jpg" }
        ) {
          publicURL
        }

        defaultFb: file(relativePath: { eq: "default-meta-min.png" }) {
          publicURL
        }
      }
    `
  ...
  return (
    <>
      ...
      <SchemaOrg
        ...
        canonicalUrl=""
        author=""
        organization="Friends of Stars Experience Alberta"
        defaultTitle="Friends of Stars Experience Alberta"
      />
    </>
  )
}
